...
import SEMANTIC.SEMANTIC_Pair;

public class CODEGEN_StringCollector 
{
	public static List<SEMANTIC_Pair<String,String>> labelAndStringMappings;

	public static void reset(){
		labelAndStringMappings = new ArrayList<SEMANTIC_Pair<String,String>>();
	}
	...
	public static String addStringAndLabelMapping(String str){
		...
		labelAndStringMappings.add(new SEMANTIC_Pair<String,String>(stringLabel,str));
		return stringLabel;
	}
	...
	public static void printStringsToAssembly() throws IOException{
		...
		for(int i=0;i<labelAndStringMappings.size();i++){
			SEMANTIC_Pair<String,String> currPair = labelAndStringMappings.get(i);
